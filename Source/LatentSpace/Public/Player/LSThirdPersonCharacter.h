...
#include "LSThirdPersonCharacter.generated.h"

UCLASS(config=Game)
class ALSThirdPersonCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	ALSThirdPersonCharacter(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	void UpdateGravity(FVector GravityDirection);
};
